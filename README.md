...
+ **Contribution statement**: ([default](doc/a_note_on_contributions.md))
	...
	+ Jiaqian Yu: Worked on Error Correction based on C3 - Contributed to all the processes: find proposed candidates, generate confusion matrix, calcualte the probability and find out the best "correction". Helped with presentation slides and discussed with other teammates.
